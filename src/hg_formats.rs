...
//merged in is hg_parameters_t
//TODO: reparate hg_parameters_t from graph data
pub struct hg_graph_t {
  pub data: Vec<hg_coordinate_t>, //TODO: replace with add_vertex_cb
  //add_edge_cb, Fn(id: u32, other_id),
  //add_vertex_cb: Fn(id: u32, r: f64, theta: f64),
  //pub get_rnd_cb: RCB, //get random value in the range of [0,1[
}

impl hg_graph_t {
  pub fn new(/*get_rnd_cb: RCB*/) -> Self {
    Self {
      data: vec![],
      //get_rnd_cb: get_rnd_cb,
    }
  }

  pub fn add_edge(&mut self, id: u32, other_id: u32) {
    println!("\t\tNew link: {} - {} ", id, other_id);
  }
}
*/

//pub type hg_graph_t = Vec<hg_parameters_t>;
